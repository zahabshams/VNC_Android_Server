...
//static char KBD_DEVICE[256] = "/dev/input/event3";   // commented as event3 does not exist at /dev/input  .. zahab
static char KBD_DEVICE[256] = "/dev/input/event2";     // for testing at /dev/input/event2  .. zahab
